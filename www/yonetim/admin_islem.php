...
session_start();
ob_start();
// sayfaya eriþim yapan kiþinin admin yetkisini kontrol ediyoruz
if(!isset($_SESSION["yetki"]))
{
echo str_repeat("<br>", 8)."<center><img src=images/hata.gif border=0 /> Yönetim Paneli sadece yetkili kullanýcýlara açýktýr!</center>";
