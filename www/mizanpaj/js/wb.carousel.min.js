...
document.getElementsByTagName("body"));$(b).parent().css("width","100%");$(b).parent().css("left","0");var a=$(b).data("carousel");$(b).css("width",a.count*c+"px");a.total_width=a.count*c;a.width=c;$(b).parent().find(".frame").each(function(b){$(this).css({width:c+"px"});var d=(c-a.original_width)/2+(c-a.original_width)*b;$(this).children().each(function(){var a=0,a=$(this).data("left");void 0!=a?a=parseInt(a):(a=parseInt($(this).css("left")),$(this).data("left",a+"px"));$(this).css("left",a+d+"px")})});
$(b).css({left:-a.width*a.currentFrame})}function A(b){var c=$(b).data("carousel");if(c.original_width!=$(b).parent().outerWidth()){c.width=$(b).parent().outerWidth();c.original_width=$(b).parent().outerWidth();c.total_width=$(b).parent().outerWidth()*c.count;$(b).css("width",c.total_width+"px");var a=c.duration;c.duration=0;w($(b));x($(b));c.duration=a}}function D(b){s=b.targetTouches[0].pageX;t=b.targetTouches[0].pageY;u=s;v=t;r(e)}function E(b){b.preventDefault();u=b.targetTouches[0].pageX;v=b.targetTouches[0].pageY;
var c=u-s,a=v-t;b=Math.round(Math.sqrt(Math.pow(c,2)+Math.pow(a,2)));c=B(c,a);"left"==c?h(e,f.width*f.currentFrame+b,0,""):"right"==c&&h(e,f.width*f.currentFrame-b,0,"")}function F(b){var c=u-s,a=v-t;50<=Math.round(Math.sqrt(Math.pow(c,2)+Math.pow(a,2)))?(b=B(c,a),"left"==b?w(e):"right"==b&&x(e)):C(b)}function C(b){v=u=t=s=0;h(e,f.width*f.currentFrame,f.duration,f.easing)}function B(b,c){var a=Math.atan2(c,-b),a=Math.round(180*a/Math.PI);0>a&&(a=360-Math.abs(a));return 45>=a&&0<=a||360>=a&&315<=a?
"left":135<=a&&225>=a?"right":45<a&&135>a?"down":"up"}var s=0,t=0,u=0,v=0,e=q(g);if(d&&"string"==typeof d)if("next"==d)r(e),n(e,0);else if("prev"==d)r(e),n(e,1);else{if(-1!=d.indexOf("goto")){r(e);var k=d.slice(5);y(e,k)}}else{var k=e.find(".frame"),l=e.parent(),p=0;if("backward"==d.mode||"backward-circular"==d.mode)p=1;var f={count:k.length,currentFrame:0,direction:p,duration:d.duration,easing:d.easing,scalemode:d.scalemode,killtimer:d.killtimer,mode:d.mode,pagination:d.pagination,pagination_img_default:d.pagination_img_default,
pagination_img_active:d.pagination_img_active,width:l.outerWidth(),original_width:l.outerWidth(),total_width:l.outerWidth()*k.length};e.css("width",f.total_width+"px");e.data("carousel",f);if(d.pagination){$pagination=$('<div class="pagination" />');for(l=0;l<k.length;l++)p=$("<a />").attr("id",String(l+1)).css("cursor","pointer"),$("<img />").attr({id:"page_"+String(l+1),src:d.pagination_img_default}).appendTo(p),p.click(function(){y(e,$(this).attr("id"))}),p.appendTo($pagination);$pagination.appendTo(e.parent());
m(e,0,0)}0!=d.start&&(f.currentFrame=d.start,f.pagination&&m(e,0,f.currentFrame),h(e,f.width*f.currentFrame,0,""));"forward-backward"==d.mode&&(0==d.start&&$("#"+e.attr("id")+"_back").css("display","none"),d.start>=k.length-1&&$("#"+e.attr("id")+"_next").css("display","none"));0!=d.delay&&(k=setInterval(function(){n(e,e.data("carousel").direction)},d.delay),e.data("timerId",k));"Microsoft Internet Explorer"!=navigator.appName&&(g.addEventListener("touchstart",D,!1),g.addEventListener("touchmove",
E,!1),g.addEventListener("touchend",F,!1),g.addEventListener("touchcancel",C,!1));1==d.scalemode?(z(g),$(window).resize(function(){z(g)})):2==d.scalemode&&(A(g),$(window).resize(function(){A(g)}))}}})(jQuery);